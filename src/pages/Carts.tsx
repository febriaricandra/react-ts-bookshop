                        ...
                        <div className="space-y-4 rounded-lg border p-4 shadow-sm border-gray-700 bg-gray-800 sm:p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <dl className="flex items-center justify-between gap-4 border-t pt-2 border-gray-700">
                                    ...
                                    <dd className="text-base font-bold text-gray-900 text-white">${orderSummary.toFixed(2)}</dd>
                                </dl>
                            </div>

                            <button
                                onClick={handleCheckout}
                                type="button" className="w-full text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">Proceed to checkout</button>
                        </div>
                    </div>
                </div>
            </div>
