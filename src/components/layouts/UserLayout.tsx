...
function UserLayout() {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-50 flex flex-col lg:flex-row w-full overflow-auto relative">
            {/* Sidebar */}
            <div className="w-full lg:w-80 p-4 border-b lg:border-r lg:border-b-0 border-slate-800">
                ...
                <div className="flex items-center justify-between mb-6 p-2 ">
                    ...
                    <button
                        ...
                        className="text-slate-400 hover:text-slate-300 block md:hidden"
                    >
                ...
                {/* Navigation */}
                <SideNavProfile isSidebarOpen={isSidebarOpen} data={data} />
            </div>

            {/* Main Content */}
            <div className="flex-1 mb-28">
                <Outlet />
                <footer className="fixed bottom-0 z-50 w-full shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 bg-gray-800 antialiased">
